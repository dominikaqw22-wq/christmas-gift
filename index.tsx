...
const SLIDES = [
  ...
  { text: "Imagine how fun it would be, us walking in the snow, laughing, talking, just enjoying the holidays together…", mood: "warm" },
...
function AvatarJourney({ currentSlide, avatarsFadingOut }: { currentSlide: number; avatarsFadingOut?: boolean }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: isMobile ? 'clamp(240px, 32vh, 300px)' : '288px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: isMobile ? '-1vh' : '0', marginBottom: isMobile ? '0' : '0.5rem', opacity: avatarsFadingOut ? 0 : 1, transition: 'opacity 0.8s ease-out', overflow: 'visible' }}>
        ...
        <div style={{
          ...
          {!isFinal ? (
            <>
              ...
              <div style={{
                 marginTop: isMobileView ? 'clamp(0.5rem, 1.5vh, 1rem)' : '4rem',
            ...
            <div style={{ position: 'relative', marginTop: isMobileView ? 'clamp(3vh, 5vh, 6vh)' : '0', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: isMobileView ? '0 0.75rem 2rem' : '0 1rem 3rem', minHeight: 'auto', justifyContent: 'flex-start', zIndex: 250, overflow: 'visible' }}>
